...
namespace KingIT
{
    ...
    public partial class Shopping_CenterEntities : DbContext
    {
        private static Shopping_CenterEntities _context;
        public Shopping_CenterEntities()
        : base("name=Shopping_CenterEntities")
        {
        }
        public static Shopping_CenterEntities GetContext()
        {
            if (_context == null)
                _context = new Shopping_CenterEntities();
            return _context;
        }
